...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, train=None, validation=None, test=None, predict=None,
                 wrap=False, num_workers=0, shuffle_test_loader=False, use_worker_init_fn=False,
...
if __name__ == "__main__":
    ...
    #    print(f"parameters {name}, requires_grad: {param.requires_grad}")
    ...
    if hasattr(model, "monitor"):
        ...
        default_modelckpt_cfg["params"]["save_top_k"] = 3 #30
